package com.register.repository.server.domain;

import com.register.repository.server.application.dto.*;
import com.register.repository.server.domain.model.*;
...
public class OrikaBeanMapper extends ConfigurableMapper {
    ...
    protected void configure(MapperFactory factory) {
        ...
        registerClassMap(Application.class, ApplicationDto.class);
        registerClassMap(ApplicationComponent.class, ApplicationComponentDto.class);
        registerClassMap(Clazz.class, ClazzDto.class);
        registerClassMap(Enumeration.class, EnumerationDto.class);
        registerClassMap(EnumerationLiteral.class, EnumerationLiteralDto.class);
        registerClassMap(Operation.class, OperationDto.class);
        registerClassMap(Parameter.class, ParameterDto.class);
        registerClassMap(Property.class, PropertyDto.class);
        registerClassMap(ServiceInterface.class, ServiceInterfaceDto.class);
        registerClassMap(Type.class, TypeDto.class);
